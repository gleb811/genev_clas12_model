...
//For final hadron #2
 ...
 P4_2.SetTheta(acos((m1*m1+m2*m2+2*P4_1[3]*P4_2[3]-M12*M12)/2./P4_1.Vect().Mag()/P4_2.Vect().Mag()));
 P4_2.SetPhi(alpha_hadr);
//th_2 = acos((m1*m1+m2*m2+2*en_1*en_2-M12*M12)/2./mag_1/mag_2);
//ph_2 = alpha_hadr;
 
//For final hadron #3 
 P4_3.SetTheta(acos((m1*m1+m3*m3+2*P4_1[3]*P4_3[3]-M13*M13)/2./P4_1.Vect().Mag()/P4_3.Vect().Mag()));
...
//if (alpha_hadr <= M_PI) ph_3 = alpha_hadr + M_PI;
//cout << "qqq1 " << P4_2.Rho() << "\n";
//cout << "qqq2 " << sqrt(P4_2[3]*P4_2[3]-m2*m2) << "\n";
...
if (!((P4_3.Mag()>0)||(P4_3.Mag()<0))) cout << P4_3.Mag()<<"   "<<G_BYCKLING1(M12*M12,M23*M23,W*W,m2*m2,m1*m1,m3*m3)<<"\n"; 
