...
#include <vertex.h>  
  ...
  using namespace std;  
    ...
    extern Short_t flag_bos, flag_lund, flag_radmod;
  
    extern string out_bos_file, out_lund_file;
   extern  Float_t E_beam, W_min, W_max, Q2_min,Q2_max,Theta_min,Theta_max,E_eprime_min;
  ...
  extern  Float_t FIT_PARAM_SIGMA_CF[3][17];      
   ...
   extern Float_t FIT_PARAM_SIGMA_CF_FED[3][10]; 
    ...
    extern   Float_t W_ARR_RIP2[11];
    extern   Float_t S12_ARR_RIP2[12][11];
    extern   Float_t S23_ARR_RIP2[12][11];
    extern   Float_t SIGMA_ARR_RIP2[6][11][12][12][6][6];
    extern    Float_t EPS_L_RIP2[11];
