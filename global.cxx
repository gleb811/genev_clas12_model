...
#include <vertex.h>
 ...
 //----
    ...
    Short_t flag_bos, flag_lund, flag_radmod;
  
    string out_bos_file, out_lund_file;
    Float_t E_beam, W_min, W_max, Q2_min,Q2_max,Theta_min,Theta_max,E_eprime_min;
  ...
  Float_t SIGMA_ARR_FED[6][7][12][10][10][8][8];
   ...
   Float_t W_ARR_RIP2[11];
   Float_t S12_ARR_RIP2[12][11];
   Float_t S23_ARR_RIP2[12][11];
   Float_t SIGMA_ARR_RIP2[6][11][12][12][6][6];
   Float_t EPS_L_RIP2[11];
