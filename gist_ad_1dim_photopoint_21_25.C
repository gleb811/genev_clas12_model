void gist_ad_1dim_photopoint_21_25 () {
gStyle->SetOptStat(0);
...
//TFile *MyFile1 = new TFile("qqq_31May_test.root","READ");
TFile *MyFile1 = new TFile("qqq_1Jun_test_2.root","READ");
TFile *MyFile2 = new TFile("mok_model_1dim_plots_0_golovach_18_25.root","READ");
...
MyFile1->cd();
//i=7;
qqq << "h_odn_wwide_inv_m23_" << 10000*(2.1875+0.05*i);
cout << qqq.str().c_str() <<"\n";
