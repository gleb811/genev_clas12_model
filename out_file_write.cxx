...
void out_file_write(int& i, TLorentzVector &P4_E, TLorentzVector &P4_1, TLorentzVector &P4_2, TLorentzVector &P4_3) {
...
//-----------------------------------------------------------------------    
  ...
  clasMCVX_t* MCVX ;
  if ( ( MCVX = (clasMCVX_t*)makeBank( &bcs_, "MCVX", 0, sizeof(mcvx_t)/4, 4 ) ) )
    {
      MCVX->mcvx[0].x = 0.; 
      MCVX->mcvx[0].y = 0.;
      MCVX->mcvx[0].z = z_EL;
