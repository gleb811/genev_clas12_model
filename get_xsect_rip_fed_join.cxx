...
//4 - then we calculate sigma total
//5 - then we multiply obtained sigma_total by virtual photon flux
...
if (((Wgen>=1.4375)&&(Wgen<=1.4625)&&(Q2gen>=0.525)&&(Q2gen<=0.575))||((Wgen>=1.4875)&&(Wgen<=1.5125)&&(Q2gen>=0.425)&&(Q2gen<=0.525))||((Wgen>=1.5125)&&(Wgen<=1.5375)&&(Q2gen>=0.325)&&(Q2gen<=0.425))||((Wgen>=1.5375)&&(Wgen<=1.5625)&&(Q2gen>=0.275)&&(Q2gen<=0.325))||((Wgen>=1.5625)&&(Wgen<=1.5875)&&(Q2gen>=0.225)&&(Q2gen<=0.275))){
...
Float_t factor;
/*
factor = 1./fabs(W_ARR[Wright_bin_rip]-W_ARR[Wleft_bin_rip]);
factor = factor/fabs(Q2_ARR[Q2_bin_rip]-Q2_ARR_FED[Q2_bin_fed]);

sigma_final[i] = sigma_wl_rip[i]*fabs(W_ARR_FED[Wright_bin_fed]-Wgen)*fabs(Q2_ARR_FED[Q2_bin_fed]-Q2gen);
sigma_final[i] = sigma_final[i] + sigma_wr_rip[i]*fabs(W_ARR_FED[Wleft_bin_fed]-Wgen)*fabs(Q2_ARR_FED[Q2_bin_fed]-Q2gen);


sigma_final[i] = sigma_final[i] + sigma_wl_fed[i]*fabs(W_ARR[Wright_bin_rip]-Wgen)*fabs(Q2_ARR[Q2_bin_rip]-Q2gen);
sigma_final[i] = sigma_final[i] + sigma_wr_fed[i]*fabs(W_ARR[Wleft_bin_rip]-Wgen)*fabs(Q2_ARR[Q2_bin_rip]-Q2gen);
sigma_final[i] = sigma_final[i]*factor;
*/
...
if (((Wgen>=1.3125)&&(Wgen<1.5125)&&(Q2gen>=0.002)&&(Q2gen<=0.275))||((Wgen>=1.5125)&&(Wgen<=1.5875)&&(Q2gen>=0.002)&&(Q2gen<=0.225))){
...
if ((Wgen>=1.3125)&&(Wgen<=1.5125)&&(Q2gen>=0.002)&&(Q2gen<=0.275)){
Q2_edge_r = 0.275;
Q2_edge_l = 0.275;
...
if ((Wgen>=1.5125)&&(Wgen<=1.5875)&&(Q2gen>=0.002)&&(Q2gen<=0.225)){
Q2_edge_l = 0.225;
Q2_edge_r = 0.225;
...
if ((Wgen>=1.4875)&&(Wgen<1.5125)&&(Q2gen>=0.002)&&(Q2gen<=0.275)){
Q2_edge_l = 0.275;
Q2_edge_r = 0.225;
